...
| Req ID | Requirement | Priority | Evidence |
|--------|-------------|----------|----------|
...
| FR-16 | Every implemented feature shall be traceable to the corresponding user story, evidence, and MVP feature list. | Must | Required by Lab 04 guidelines. |
...
|--------|-------------|----------|
| NFR-01 | The interface shall be simple and easy to learn for first-time users. | Must |
| NFR-02 | The system shall respond quickly when loading assignment information. | Should |
| NFR-03 | The system shall maintain consistent colors, navigation, and layouts. | Must |
| NFR-04 | The system shall be accessible through modern web browsers. | Must |
| NFR-05 | The prototype shall be responsive on laptops and smartphones. | Should |
